# <span class="status status-list"><span class="status status-list">R</span> Zakony</span>
<br />
...
<span class="status status-title">Co musisz zanotować [🖶](wszystkie_materialy_do_pobrania.md#zakony):</span> już wkrótce ...
<br />
