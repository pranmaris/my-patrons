...
1. Wybierz **patrona**, który **nie jest jeszcze Twoim orędownikiem**, czyli ma status w kolorze: <span class="status status-black">czarnym</span>, <span class="status status-yellow">zółtym</span>, <span class="status status-green">zielonym</span> albo <span class="status status-blue">niebieskim</span> i **druga osoba umożliwia Tobie jego zaproszenie** poprzez choć jedno z kryteriów:
    - <span class="selected-day-info">a)</span> jest on **Patronem Przyjacielem** tej osoby (patrz jej lista [<span class="status status-list"><span class="status status-white">P</span> Patroni Przyjaciele</span>](patroni_przyjaciele.md)),
    - <span class="selected-day-info">b)</span> jest on **patronem imienia tej osoby**: z Chrztu św. (pierwsze, drugie), Bierzmowania lub przyjętych imion zakonnych (patrz jej lista [<span class="status status-list"><span class="status status-list">YA</span> Osiągnięcie: Patroni Moich Imion</span>](osiagniecie_patroni_moich_imion.md)),
    - <span class="selected-day-info">c)</span> **dzień roku, w którym zmarł wybrany patron** jest znany i jednoznaczny (także w przypadku śmierci w nocy z dnia poprzedniego na ten dzień) oraz **przypada w dniu urodzin drugiej osoby** (patrz jej lista [<span class="status status-list"><span class="status status-god">∞</span> Bóg</span>](bog.md)) lub w dniach roku, w których **ta osoba po raz pierwszy przyjęła dowolny z Sakramentów** (patrz jej lista [<span class="status status-list"><span class="status status-list">J</span> Sakramenty</span>](sakramenty.md)),
    - <span class="selected-day-info">d)</span> patron jest wpisany w którymkolwiek zaakceptowanym przez Papieża, oficjalnym watykańskim wydaniu **Martyrologium Rzymskiego** w dowolnym dniu roku, będącym j.w. **dniem urodzin** lub **pierwszego przyjęcia dowolnego Sakramentu** tej osoby.
    - <span class="selected-day-info">e)</span> na poniższej [stronie](https://pl.patrons.space/dates/list-of-patrons-and-immovable-feasts), **patron znajduje się na liście** dla dnia roku będącego j.w. **dniem urodzin** lub **pierwszego przyjęcia dowolnego Sakramentu** tej osoby:  
_**UWAGA!** Stale pracujemy, aby poniżej dostępni byli wszyscy patroni spełniający poprzednie kryteria wyboru: pkt <span class="selected-day-info">c)</span> i <span class="selected-day-info">d)</span>. [**Wesprzyj nas!**](https://pl.gratiadei.org/#wesprzyj-nas)_
...
- Informację, na podstawie jakiego **kryterium** wybraliśmy patrona od osoby współzapraszającej. Mogą to być następujące skróty („DD.MM” oznacza dzień i miesiąc roku, np. 16.07):
  ...
  - **DUR:DD.MM** - dzień roku urodzenia (drugiej osoby),
